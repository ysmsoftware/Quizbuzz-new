      ...
      >
        <Calendar
          ...
          classNames={{
            ...
            button_previous: "h-7 w-7 rounded-full border border-border/40 hover:border-primary hover:bg-muted/30 flex items-center justify-center transition-all cursor-pointer pointer-events-auto",
            button_next: "h-7 w-7 rounded-full border border-border/40 hover:border-primary hover:bg-muted/30 flex items-center justify-center transition-all cursor-pointer pointer-events-auto",
