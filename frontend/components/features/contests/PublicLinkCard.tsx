    ...
    const shareOptions = [
        {
            ...
            icon: Twitter,
            color: 'bg-[#1DA1F2]',
            href: `https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}&text=${encodeURIComponent('Check out this contest on QuizBuzz!')}`
        },
        {
            name: 'LinkedIn',
            icon: Linkedin,
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button size="icon" variant="outline" className="ml-auto" onClick={() => {
                            if (navigator.share) {
                                navigator.share({ title: 'QuizBuzz Contest', url });
                            }
                        }}>
