export enum MessageTemplate {
    ...
    // Org-admin notification (sent via NotificationService.notifyOrg, not to the ambassador)
    AMBASSADOR_APPLICATION_SUBMITTED_ADMIN = "AMBASSADOR_APPLICATION_SUBMITTED_ADMIN",
